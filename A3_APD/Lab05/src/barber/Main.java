...
public class Main {
    ...
    // TODO: add semaphores
    public static Semaphore semClients=new Semaphore(0);
    public static Semaphore semBarberReady=new Semaphore(0);
    public static Semaphore semChairs=new Semaphore(1);
