...
class MyRunnable implements Runnable {
    ...
    public MyRunnable(ExecutorService tpe, AtomicInteger inQueue, ArrayList<Integer> partialPath, int destination) {
    ...
    public void run() {
        ...
        for (int[] ints : Main.graph) {
            if (ints[0] == lastNodeInPath) {
                ...
                tpe.submit(new MyRunnable(tpe, inQueue, newPartialPath, destination));
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tpe.submit(new MyRunnable(tpe, inQueue, partialPath, 3));
