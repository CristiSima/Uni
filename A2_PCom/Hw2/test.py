...
port = "12345"
port = "11124"
port = str(int(os.urandom(2).hex(), 16))
...
def print_test_results():
  ...
  for test in tests:
    ...
    print(test, end="")
    print('.' * dots, end="")
    print(tests.get(test), end="")
    if(tests.get(test) == "failed"):
      print("#####")
    else:
      print("")
...
def run_test_c1_subscribe_all(server, c1, topics):
  ...
  for topic in topics:
    ...
    if not outc1.startswith("Subscribed to topic."):
      ...
      # print(server.total_input,"\n#########")
      # print(c1.total_input,"\n#########")
      # print(server.is_alive())
      # print(c1.is_alive())
      # print(server.get_output_timeout(2))
      # print(server.get_error_timeout(2))
      # print(c1.get_output_timeout(2))
      # print(c1.get_error_timeout(2))
      failed = True
      break
...
def h2_test():
  ...
  if success:
    ...
    print("#######", c1.total_input, "#######", sep="\n")
    print("#######", c1.total_output, "#######", sep="\n")
