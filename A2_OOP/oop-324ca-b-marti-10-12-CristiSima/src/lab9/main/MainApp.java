...
import lab9.storage.*;
import lab9.dataprocessing.*;
import lab9.communication.*;
...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        StepCountStrategy countStrategy = new StepCountStrategyFactory().createStrategy(strategyType, dataRepository);

        System.out.println(new ConsoleLogger());
        dataRepository.addObserver(new ConsoleLogger());
        dataRepository.addObserver(new DataAggregator(countStrategy));
