...
public class Teacher {
	...
	public Teacher(Teacher other) {
		...
		this.subjects = new ArrayList<String>(other.subjects);
	}
	...
	public List<Teacher> getAllTeachers() {
		return Database.getDatabase().getAllTeachers();
	}

	public List<Teacher> getTeachersBySubject(String subject) {
		return Database.getDatabase().getTeachersBySubject(subject);
	}

	public List<Student> getAllStudents() {
		return Database.getDatabase().getAllStudents();
	}
