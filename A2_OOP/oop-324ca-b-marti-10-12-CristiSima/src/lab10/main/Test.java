...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(new House.HouseBuilder(2, 1)
                                .build());
        System.out.println(new House.HouseBuilder(2, 1)
                                .setWindows(10)
                                .build());
        System.out.println(new House.HouseBuilder(2, 1)
                                .setWindows(10)
                                .setHeaterSystemTargetTemperature(21)
                                .build());
    }
    ...
    private static void testResize(Client client) {
        ...
        client.executeAction("resize","1","10","30");
        client.executeAction("resize","0","90","36");
        client.executeAction("draw rectangle");
        client.executeAction("resize","2","100","60");
