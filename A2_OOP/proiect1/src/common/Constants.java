...
public final class Constants {
    ...
    public static final double CHILD_KID_SCORE = 10;
    public static final double CHILD_YOUNGADULT_SCORE = 0;
    public static final Integer CHILD_AGETRESHOLD_KID = 5;
    public static final Integer CHILD_AGETRESHOLD_TEEN = 12;
    public static final Integer CHILD_AGETRESHOLD_YOUNGADULT = 18;
